...
# Етикети в слайдовете

Във всяка презентация или документ се слагат **визуални етикети**: `Under Development` / `For Review` и подобни, нещюо като иконки (банери), които след това се сменят с други.
...
2. Екипът на курса заедно създава **учебна програма** (планира темите в курса и какво ще включват)
