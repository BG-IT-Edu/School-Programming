...
## Раздел 1. Управление на проекти
 ...
 - **Упражнение: Дефиниране и основни етапи в софтуерния проект**
   - Задача за създаване на Диаграма на Гант на проект по избор с помощта на ChatGPT
 - **Последователни модели**: Waterfall
   - Последователни модели - описание и примери
   - Waterfall модел - етапи, роли, предимства и недостатъци
   - Демо: Waterfall модел с Asana
 - **Упражнение: Последователни модели**
 ...
 - **Анализ на риска**
   ...
   - Демо: Матрица на риска на продукта "Google Classroom"
   - Методи за анализ на риска - въпросници, мозъчна атака (brainstorming), SWOT анализ
   - Демо: SWOT анализ на продукта "YouTube"
...
## Раздел 2. Управление на компютърни системи и приложен софтуер
  - **Компютърни конфигурации**
    ...
    - Демо: Компютърна конфигурация за лична употреба. Инструмент https://pcpartpicker.com
  - **Упражнение: Компютърни конфигурации**
    ...
    - Задача за попълване на таблица на компютърна конфигурация за гейминг при зададен фиксиран бюджет (с https://pcpartpicker.com)
  - **Приложен софтуер**
...
|  01  | Упражнение: Дефиниране и основни етапи в софтуерния проект                         |      2      |
|  02  | Последователни модели                                                              |      2      |
|  02  | Упражнение: Последователни модели                                                  |      2      |
...
|  12  | Въпроси за държавен изпит                                                          |      2      |
|      | Задължителни часове                                                                |      54     |
|      | Резерв часове                                                                      |      8      |
|      | Общ брой часове                                                                    |      62     |
