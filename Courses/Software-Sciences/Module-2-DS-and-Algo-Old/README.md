# (Архив) Модул 2. "Структури от данни и алгоритми"

Внимание: тези учебни материали са остарели и препоръчваме да не ги използвате повече. Запазваме ги тук само за архив.

Актуалната версия на учебните материали можете да намерите тук: [Модул 2. "Структури от данни и алгоритми"](https://github.com/BG-IT-Edu/School-Programming/tree/main/Courses/Software-Sciences/Module-2-DS-and-Algo)
