# Условни конструкции - допълнителни упражнения (вариант експерт) **

Урокът "**Условни конструкции - допълнителни упражнения**" (вариант експерт) дава възможност на най-напредналите ученици да усъвършенстват знанията си за конструкциите **if-else** и **switch-case** в езика C# чрез по-предизвикателни задачи.
