# Условни конструкции – още упражнения (вариант експерт) **

Практическото занимание "**Условни конструкции – още упражнения**" (вариант експерт) дава възможност на най-напредналите ученици да усъвършенстват знанията си за конструкциите **if-else** и **switch-case** в езика C# чрез по-предизвикателни задачи.

## Съдържание
 - По-предизвикателни задачи с условни конструкции (за по-напредналите)
 - Задача с GUI интерфейс (време + 15 минути)
